...
const ProductDetails = () => {
  ...
  const [reviews, setReviews] = useState([
    { rating: 4.6, text: "món ăn ngon", user: "Khánh" },
  ]);
  ...
  const addToCart = () => {
    dispatch(
      cartActions.addItem({
        ...
        quantity: quantity,
        size: sizeChoice !== undefined ? sizeChoice : "M",
      })
    );
      ...
      <section>
        <div style={{ marginLeft: "300px" }}>
          <Breadcrumb>
            ...
            <BreadcrumbItem active>{item?.productName || item?.name}</BreadcrumbItem>
          </Breadcrumb>
        </div>
        <Container>
          <Row>
            <Col lg="6">
              <img src={item?.grid_picture_url || imgUrl} className="product__detail-img" alt="product" />
            </Col>
            <Col lg="6">
              <div className="product__details">
                <h2>{item?.name || productName}</h2>
                ...
                <div className="d-flex align-items-center gap-5">
                  <span className="product__price">
                    {formatPrice(item?.retail_price_cents || item?.productPrice)}
                  </span>
                  <span>Danh mục: {Array.isArray(item?.category) ? item.category[0] : item?.category}</span>
                </div>
                <div className="mt-4">
                  <div className="pd">
                    ...
                    <div className="pd__info">
                      <h5>CÓ SẴN TẠI NHÀ HÀNG</h5>
                      <p>Giao ngay trong ngày</p>
                    </div>
                    <div className="pd__info">
                      <h5>ĐỔI TRẢ DỄ DÀNG</h5>
                      <p>Khi không hài lòng</p>
                    </div>
                  </div>
                </div>
                <div className="mt-4">
                ...
                <div className="mt-5 select-container">
                  ...
                  <div className="d-flex mx-5 gap-5">
                    ...
                    />
                    <span>{item?.quantity || 50} món có sẵn</span>
                  </div>
                  <div></div>
                </div>
                {/*  */}
            ...
            <Col lg="12">
              ...
              {tab === "desc" ? (
                <div className="tab__content mt-5">
                  <p>{item?.story_html || item?.description || "Món ăn truyền thống Việt Nam với hương vị đậm đà, được chế biến từ những nguyên liệu tươi ngon nhất."}</p>
                </div>
              ) : (
